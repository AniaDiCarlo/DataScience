...
#per l'ordine delle barre dell'istogramma
...
ggplot(heroes) + 
  ...
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90), #tick labels along axes
...
Most_powerful_heroes %>%
  ...
  geom_bar(stat = "identity") + # identiy leaves the data as it is
...
Infatti il divario tra buoni e cattivi-neutrali sembra diminuire di molto, arrivando ad una differenza di solo il 60%.

Quindi chi è più intelligente è più probabile che tenda a schierarsi "on the dark side", o comunque tenda a rimanere neutrale (probabilmente prendendo posizione in una delle due parti a seconda della convenienza). 
...
* Icon Comics ha un bilanciamento globale di genere lievemente migliore, e **IL 100% dei supereroi intelligenti sono femmine**
* ABC Studios ha il bilanciamento globale di genere migliore in assoluto (50% vs 50%) ma **IL 100% dei supereroi intelligenti sono maschi**
...
Al primo posto abbiamo gli **dei**, con una percentuale del 64% (9 su 14),
Al secondo posto abbiamo gli **umani**, con una percentuale del 27% (57 su 208),
E infine gli **mutanti**, con una percentuale del 14% (9 su 63).
